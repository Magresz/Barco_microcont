...
ISR(TIMER2_COMPA_vect){         //Contador para o servo e tempo de transmissão
...
int main(void)
{
 ...
 Timer2_CTC(); //Contador para utilização do Servo Motor e transmissão de dados
  ...
  {    
      ...
      if(serial[0] == 1){ // Botão X pressionado
          aut_flag=1;
      }
     
      if(serial[1] == 1){ //Botão Quadrado pressionado
          aut_flag=0;
      }
      //-------------------- Modo Controle -------------------
